        ...
        <div className='followerTab_title'>
            ...
            <div className='followerTab_tabs'>
                <div className='followerTab_tabs_btn'>
                    <button onClick={()=>openPopular()}><RiUserFollowFill/>Popular</button>
                    <button onClick={()=>openFollower()}><RiUserFollowFill/>Following</button>
                    <button onClick={()=>openNews()}><RiAwardLine/>NoteWorthy</button>
                </div>
            </div>
        </div>
        {popular && (
            <div className='followerTab_box'>
                {cardArray.map((el, i)=> (
                    <FollowerTabCard key={i+1} i={i+1} el={el}/>
                ))}
            </div>
        )}
        {following && (
